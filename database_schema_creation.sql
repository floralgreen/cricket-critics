...
#tabella categories
CREATE TABLE if not exists cricketcritics_local.categories (
	id BIGINT NOT NULL,
	name varchar(100) NOT NULL,
	CONSTRAINT categories_pk PRIMARY KEY (id),
	CONSTRAINT categories_unique UNIQUE KEY (name)
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_0900_ai_ci;
...
#tabella congiunzione categories e movies per N:N
CREATE TABLE if not exists cricketcritics_local.categories_movies (
	movie_id BIGINT NOT NULL,
	category_id BIGINT NOT null,
	constraint movie_category_fk foreign key  (movie_id) references movies(id),
	constraint category_movie_fk foreign key (category_id) references categories(id)
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_0900_ai_ci;
